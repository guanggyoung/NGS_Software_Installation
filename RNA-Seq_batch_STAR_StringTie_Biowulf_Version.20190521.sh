...
## MultiQC is installed using conda under NGS_analysis environment
## $ conda config --add channels conda-forge
## $ conda config --add channels defaults
## $ conda config --add channels r
## $ conda config --add channels bioconda
## $ conda create --name NGS_analysis multiqc 
## #Create a new environment  named NGS_analysis 
## # and install multiqc in this environment
## $ source activate NGS_analysis 
## #Activate the environment ‘NGS_analysis’
## #To deactivate an active environment, use: source deactivate
## ***********************************************************************************##

## ************** How to submit the job on Biowulf **********************##
## sbatch --cpus-per-task=8 --mem=64g RNA-Seq_batch_STAR_StringTie_Biowulf_Version.20190521.sh
##############################################################################################
...
# Use full path.
top_level_folder="/home/guang/data/HeLa4SU190411"

######### Parameters related to fastqc and multiqc #########
module load fastqc
module load multiqc
############################################################
...
execute_Trimmomatic="java -jar $TRIMMOJAR"
# Paired-end Trimmomatic adapter file
PE_Trimmomatic_adapter="/usr/local/apps/trimmomatic/Trimmomatic-0.36/adapters/TruSeq3-PE.fa"
# Single-end Trimmomatic adapter file
SE_Trimmomatic_adapter="/usr/local/apps/trimmomatic/Trimmomatic-0.36/adapters/TruSeq3-SE.fa"
######################################################

######### Parameters related to STAR and alignment ###############
module load STAR
module load samtools
genome_STAR_index_Dir="/home/guang/human_genome_index/RNA_STAR_overhang100"
####################################################

######### Parameter for StringTie #############
module load stringtie
gtf_annotation="/home/guang/human_genome/Homo_sapiens.GRCh38.96.gtf"
###############################################
...
do
	...
	fastqc *.fastq.gz -O ./$sample_folder\_fastqc_results/
...
# "module load fastqc" is enough in biowulf
### source activate NGS_analysis 
# Activate the 'NGS_analysis' environment which installed MultiQC program.
...
do
	...
	# ILLUMINACLIP:/home/guang/bio_softwares/Trimmomatic-0.39/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 \
...
do
	...
	STAR --runThreadN 6 \
    # --genomeDir /home/guang/human_genome_index/RNA_STAR_overhang100 \
